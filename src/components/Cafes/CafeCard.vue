          ...
          <v-card>
            ...
            >
              <v-list
                lines="one"
                subheader
                v-for="(categoryItems, category) in categorizedMenuItems"
                :key="category"
                cols="6"
              >
                <v-list-subheader v-text="category"></v-list-subheader>
                <v-list-item
                  v-for="(item, id) in categoryItems"
                  :key="id"
                      ...
                      <template v-slot:default="{ isActive }">
                        <v-card>
                          ...
                          <v-card-text>
                            <div
                              class="text-h5 pa-2"
                              v-text="'Amount: ' + menuItem.amount"
                            ></div>
                          </v-card-text>
                          <v-card-text>
                            <div
                              class="text-h5 pa-2"
                              v-text="'Category: ' + menuItem.categoryName"
                            ></div>
                          </v-card-text>
                          <v-card-text>
                            <div
                              class="text-h5 pa-2"
                              v-text="'Price: ' + menuItem.price + 'RSD'"
                            ></div>
                          </v-card-text>
            ...
            <v-col cols="8" v-else align-self="center">
              <v-card-title class="text-center"
                >Sorry this menu doesnt have any items in it!</v-card-title
              >
            </v-col>
            <!-- <v-list
                lines="two"
