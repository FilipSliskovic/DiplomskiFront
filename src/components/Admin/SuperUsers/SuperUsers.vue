<template>
  ...
  >
    <template #newItemSlot>
      ...
      <v-col cols="12" sm="7" md="5">
        <v-checkbox
          v-model="ChangeSuperUser.GiveSuperUser"
          :label="`SuperUser: ${ChangeSuperUser.GiveSuperUser.toString()}`"
        ></v-checkbox>
      </v-col>
    </template>
...
export default {
  ...
  methods: {
    ...
    GetUpdateItem(item) {
      ...
      this.ChangeSuperUser.GiveSuperUser = true;
